                                ...
                                <table id="bootstrap-data-table" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT students.*, grade.grade, grade.result, grade.created_at, students.id AS studentid, grade.created_at AS date, class.batch AS batch_year FROM students 
                                                ...
                                                LEFT JOIN grade ON grade.student_id = students.id AND grade.subject_id = '$subject_id' AND grade.batch = '$class_batch'
                                                WHERE  class.subject_id = '$subject_id' AND class.batch = '$class_batch' ";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) { ?>
                                                <tr>
                                                    ...
                                                    <td><a href="computeGrade.php?student_id=<?php echo $row['studentid'] ?>&subject_id=<?php echo $subject_id ?>&batch=<?php echo $row['batch_year'] ?>"
