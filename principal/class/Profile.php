...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($action === 'profile') {
        ...
        $query = "UPDATE users SET fname='$fname', mname='$mname', lname='$lname', email='$email', contact='$contact', street='$street', city='$city', province='$province' WHERE id='$id'";
        // I-execute ang query
        ...
        if (password_verify($old_password, $db_password)) {
            ...
            if ($new_password === $confirm_password) {
                ...
                $query_update_password = "UPDATE users SET password='$hashed_password' WHERE id='$id'";
