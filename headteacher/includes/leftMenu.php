    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown <?php echo in_array(getCurrentPage(), ['headTeacher.php', 'faculty.php']) ? 'active' : ''; ?>">
                ...
                <li class="menu-item-has-children dropdown <?php echo getCurrentPage() == 'student.php' ? 'active' : ''; ?>">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="menu-item-has-children dropdown <?php echo getCurrentPage() == 'subject.php' ? 'active' : ''; ?>">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="menu-item-has-children dropdown <?php echo getCurrentPage() == 'section.php' ? 'active' : ''; ?>">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="menu-item-has-children dropdown <?php echo getCurrentPage() == 'class.php' ? 'active' : ''; ?>">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
